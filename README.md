...
**✨ New:** We started public beta for **extensions API** that will allow you to build and share rich extensions in Raycast. Learn more [here](https://github.com/raycast/extensions).
