...
| mode                 | Specifies how the script is executed and how the output is presented. [Details of the options for this parameter can be viewed here](./OUTPUTMODES.md) | Yes      | 0.29+               |
...
| argument[1...3]      | [Custom arguments, see Passing Arguments page](./ARGUMENTS.md) for detail of how to use this field | No | 1.2.0+ |
