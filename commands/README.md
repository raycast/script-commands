...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | 🔫 | [Kill AirDrop Processes](system/quit-airdrop-process.sh) | Force kill all AirDrop processes | [Linus Salzmann](https://github.com/linus569) |  |  | <img src="images/icon-bash.png" width="20" height="20" title="Bash"> |
