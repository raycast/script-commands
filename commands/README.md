...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | 🖥 | [Toggle Sidecar](system/sidecar-toggle.template.applescript) | Toggles a Sidecar screen. | [Marcos Sánchez-Dehesa](https://www.github.com/dehesa) |  | ✅ | <img src="images/icon-applescript.png" width="20" height="20" title="AppleScript"> |
