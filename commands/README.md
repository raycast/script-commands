...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | 🤖 | [Count Characters](developer-utils/count-characters.py) | Counts the characters of either the clipboard or the passed argument | [Sven Bendel](https://github.com/ubuntudroid) | ✅ |  | <img src="images/icon-python.png" width="20" height="20" title="Python"> |
