...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | 💻 | [Json Stringify Text](developer-utils/json-stringify-text.js) | Get JSON-formatted text | [Senthil Prabhu](https://github.com/senthilprabhut) |  |  | node |
...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | 👓 | [Toggle All Filename Extensions](system/toggle-all-filename-extensions.applescript) | A script command to show and hide extensions of filenames (like .txt, .png) | [Senthil Prabhu](https://github.com/senthilprabhut) |  |  | <img src="images/icon-applescript.png" width="20" height="20" title="AppleScript"> |
