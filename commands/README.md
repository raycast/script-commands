...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | ⚠️ | [Kill Runnig Process](system/kill-process.sh) | Force kill a running process | [Gustavo Santana](https://www.gumadeiras.com) | ✅ | | <img src="images/icon-bash.png" width="20" height="20" title="Bash"> |
