...
| :--: | ----- | ----------- | :----: | :--: | :---: | :--: |
  ...
  | 🔗 | [Simple Markdown Link Generator](conversions/inputs-to-markdown-link.sh) | N/A | [atzzCokeK](https://github.com/atzzCokeK) | ✅ |  | <img src="images/icon-bash.png" width="20" height="20" title="Bash"> |
