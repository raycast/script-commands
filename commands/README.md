...
| :--: | ----- | ----------- | :----: | :--: | :---: | :--: |
  ...
  | 🐚 | [Toggle Lid Sleep](system/toggle-lid-sleep.sh) | Prevent sleep when laptop lid's closed (clamshell mode) | [Ivan Rybalko](https://github.com/ivribalko) |  |  | <img src="images/icon-bash.png" width="20" height="20" title="Bash"> |
