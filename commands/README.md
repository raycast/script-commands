...
| :--: | ----- | ----------- | :----: | :--: | :---: | :--: |
  ...
  | <img src="https://raw.githubusercontent.com/raycast/script-commands/master/commands/developer-utils/images/microlink.png" width="20" height="20"> | [Microlink API](developer-utils/microlink.sh) | Microlink API integration | Kiko Beats | ✅ |  | <img src="images/icon-bash.png" width="20" height="20" title="Bash"> |
