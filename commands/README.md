...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | 💻 | [JSON Stringify Text](developer-utils/json-stringify-text.sh) | JSON-formats the text currently in clipboard and copies it again | [Senthil Prabhu](https://github.com/senthilprabhut) |  |  | <img src="images/icon-nodejs.png" width="20" height="20" title="Node.js"> |
