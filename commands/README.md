...
| ---- | ----- | ----------- | ------ | ---- | ----- | ---- |
  ...
  | 📟 | [WIFI Password](system/wifi-password.sh) | Copy WIFI password from current session. | [Astrit](https://www.github.com/astrit) |  |  | <img src="images/icon-bash.png" width="20" height="20" title="Bash"> |
#### Audio
